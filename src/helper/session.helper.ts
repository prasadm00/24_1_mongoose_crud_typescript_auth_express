...
export const getGoogleOauthToken = async ({
    ...
    const options = {
        ...
        redirect_uri: process.env.GOOGLE_OAUTH_REDIRECT_FULL,
        grant_type: "authorization_code",
    };
    console.log("🚀 ~ file: session.helper.ts:28 ~ options:", options)
    try {
        ...
        console.log("🚀 ~ file: session.helper.ts:31 ~ data:", data)
        return data;
    } catch (err: any) {
